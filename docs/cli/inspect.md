...
`burger-api inspect` prints a summary of everything the CLI discovers in your project: config, routes, hooks, plugins, and convention-file coverage. Run it from your project root — no flags.
